...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "economics.landlord_work": "Landlord's Premises Work",
  "economics.opex_base_year": "Escalations (OPEX)",
  "economics.tax_base_year": "Escalations (RE Taxes)",
